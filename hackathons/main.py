...
# --------- #
app = FastAPI()
firebase_config = json.load(open('./auth/frontend-config.json'))

templates = Jinja2Templates(directory="hackathons/templates/")
app.mount("/static", StaticFiles(directory="hackathons/static"), name="static")
...
async def startup():
    cred = credentials.Certificate("./auth/work-in-virginia-firebase-adminsdk-89yew-bdc69f2ebe.json")
